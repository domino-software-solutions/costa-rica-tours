...
const About = (): JSX.Element => {
  return (
    <section id="about" className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
      <h2 className="text-2xl sm:text-3xl font-semibold text-[#1F2937] text-center mb-8 sm:mb-12 tracking-tight">
        Meet Your Guides
      </h2>
        ...
        <div className="flex flex-col items-center w-full">
          <div className="w-full">
            <Link href="/guides/erick" className="block w-full group">
              ...
              <p className="mt-3 text-lg font-medium text-[#1F2937] text-center">Erick Miranda</p>
            </Link>
          </div>
        </div>
        <div className="flex flex-col items-center w-full">
          <div className="w-full">
            <Link href="/guides/glenda" className="block w-full group">
              ...
              <p className="mt-3 text-lg font-medium text-[#1F2937] text-center">Glenda Araya</p>
            </Link>
          </div>
        </div>
      </div>
      <div className="mt-8 space-y-4 sm:space-y-6">
        ...
        <p className="text-base sm:text-lg text-[#4B5563] font-normal leading-relaxed italic">
