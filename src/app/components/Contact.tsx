      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
        <div className="space-y-6 sm:space-y-8">
          <div>
            ...
            <p className="text-base sm:text-lg text-black font-light leading-relaxed">
          ...
          <div className="space-y-2">
            <p className="text-black font-light text-sm sm:text-base">✓ Custom groups of any size welcome</p>
            <p className="text-black font-light text-sm sm:text-base">✓ Fluent in Spanish and English</p>
            <p className="text-black font-light text-sm sm:text-base">✓ Over a decade of professional guiding experience</p>
          </div>
          ...
          <div className="border-t border-black pt-4">
            <div className="flex items-center gap-2">
              <a href="tel:+50686439040" className="flex items-center gap-2 hover:text-[#557B59] transition-colors">
                ...
                <p className="text-black text-base sm:text-lg font-medium">+506 8643 9040</p>
              </a>
            </div>
            <div className="flex items-center gap-2 mt-2">
              <a href="mailto:dualtkw@hotmail.com" className="flex items-center gap-2 hover:text-[#557B59] transition-colors">
                ...
                <p className="text-black text-base sm:text-lg font-medium">dualtkw@hotmail.com</p>
              </a>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <a 
              ...
              className="bg-black text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-[#557B59] transition-colors duration-300 text-center font-medium flex items-center justify-center gap-2 w-full text-sm sm:text-base"
            >
            ...
            <a 
              ...
              className="bg-[#557B59] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg hover:bg-black transition-colors duration-300 text-center font-medium flex items-center justify-center gap-2 w-full text-sm sm:text-base"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 16 16">
                <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414.05 3.555ZM0 4.697v7.104l5.803-3.558L0 4.697ZM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586l-1.239-.757Zm3.436-.586L16 11.801V4.697l-5.803 3.546Z"/>
              </svg>
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4 h-[400px] sm:h-[500px] lg:h-[600px] mt-8 lg:mt-0">
          {/* Main large image */}
          ...
          <div className="relative h-[100px] sm:h-[125px] lg:h-[150px]">
            <Image
              src="/butterfly2.jpeg"
              alt="Colorful Costa Rican butterfly"
              fill
              className="object-cover rounded-lg"
          ...
          <div className="relative h-[100px] sm:h-[125px] lg:h-[150px]">
            <Image
              src="/scopeViewing.jpeg"
              alt="Wildlife viewing through scope"
              fill
              className="object-cover rounded-lg"
              sizes="(max-width: 640px) 50vw, (max-width: 1024px) 25vw, 16vw"
            />
