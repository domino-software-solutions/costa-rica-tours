        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-sm xs:prose-base sm:prose-lg xl:prose-xl max-w-none">
            ...
            <div className="my-8 xs:my-10 sm:my-12 space-y-6 xs:space-y-7 sm:space-y-8">
              <blockquote className="border-l-4 border-[#2C5530] pl-4 xs:pl-5 sm:pl-6 italic text-black text-sm xs:text-base sm:text-lg">
                ...
                <footer className="mt-2 font-medium text-black">- John C.</footer>
              </blockquote>
              ...
              <blockquote className="border-l-4 border-[#2C5530] pl-4 xs:pl-5 sm:pl-6 italic text-black text-sm xs:text-base sm:text-lg">
                ...
                <footer className="mt-2 font-medium text-black">- Anne M.</footer>
              </blockquote>
            </div>
